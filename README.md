...
- [ ] 第二阶段：记忆数据库（M-project）【数据存储与检索】---waiting
  - [x] 框架的选型和搭建，详情见M-project
  - [ ] 评估体系的构建：（换句话说，就是你的世界观、人生观、价值观，以及对某些具体场景的评价准则）
- [ ] 第三阶段：行为同步（A-project）【工具&应用场景工作流】---waiting
  - [ ] 社交行为：Bilibili，小红书，抖音，微信公众号的个性化风格分享
- [ ] 第四阶段：身体独立 (H-project)【计算本地化+物理世界**实践**与交互的能力】---waiting
